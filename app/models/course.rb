...
class Course < ActiveRecord::Base
  ...
  validates :cost, :presence  => {:message => "请填写活动花费", :if  => Proc.new {|course| !course.discount.blank? || !course.deposite.blank?}}
  ...
  validates :discount, :presence => {:message => "优惠金额在0到100000", :if  => Proc.new {|course| !course.discount_requirement.blank?}}
