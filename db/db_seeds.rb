...
#           end                                                                                             
    ...
    #                 
    #  if person  == nil   
    #    person = Person.new(:email => rand(7000000..10000000000).to_s+"fake"+"@qq.com", :nick_name  => topic_author_array[0],  :city => cities[rand(253)], :password => "rakepassword",:password_confirmation => "rakepassword", :score => 2)  
    #    #对于非图片栏目的人,可以为非学员    
    #    person.role = "学员"
    #    if person.save
    #      puts "person"
    ...
    #            comment_person = Person.new(:email => rand(7000000..10000000000).to_s+"fake"+"@qq.com", :nick_name  => author_name,  :city => cities[rand(253)], :password => "rakepassword",:password_confirmation => "rakepassword", :score => 2)      
